...
static unsigned char massageSignal,/*massage3DPluse,massage3D_Speed,*/SwtichSignal,FlexSignal;
...
unsigned char SignalBoard_GetFirstMassageSignal(void)
{
  return(massageSignal);
}

unsigned char SignalBoard_GetSecondSignal(void)
{
  return(SwtichSignal);
}
unsigned char SignalBoard_GetThreeSignal(void)
{
  return(FlexSignal);
}
