...
#define BACK_SUB_MODE_AUTO_7			7//21   			hip-up
#define BACK_SUB_MODE_AUTO_8			8//22  				golfer
#define BACK_SUB_MODE_AUTO_9		        9//23  			 care
...
#define BACK_SUB_MODE_SOFT_KNOCK		16//11
#define BACK_SUB_MODE_MUSIC			17//12
...
#define DEFAULT_SHOULDER_MAX_POSITION	370//190//该位置应该是3D动作时行走电机可以行走的最大位置，，  150// 150//    150 //8302T  
...
#define KNEAD_RUN_UNCLOCK			14//按摩臂逆时钟方向揉捏
